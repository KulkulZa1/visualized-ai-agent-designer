...
- Verification: `npx tsc --noEmit` passed; `npx vitest run` 488 tests / 44 files; `cargo test --manifest-path src-tauri/Cargo.toml` 63 tests; `cargo check` clean; `npm run build` passed.
