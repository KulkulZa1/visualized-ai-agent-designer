...
- The activity panel lists a node's helpers (status, task, tools, time, tool calls, report or error) from `AgentRun.subAgents`, updated as each helper starts and finishes.
