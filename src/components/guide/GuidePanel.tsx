...
const QA_LIBRARY: GuideQA[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      { kind: "text", text: "Snapshots are saved under .harness/snapshots/ when a workspace is open (in memory otherwise)." },
    ],
  },
  {
  ...
  },
  {
    ...
    answer: [
      ...
      { kind: "bold", text: "8 read/test tools: " },
      { kind: "text", text: "run_tests, run_cargo_tests, validate_workflow, project_status, list_workflows, list_providers (metadata and credential names only), list_artifacts (file metadata; empty until runs persist artifacts), get_recent_logs (audit-log entries with best-effort secret redaction)." },
      { kind: "text", text: "No write tools and no workflow execution." },
  ...
  },
  {
    ...
    answer: [
      ...
      { kind: "text", text: "6-tab inspector for the selected node (Role/Prompt/Tools/Hooks/Memory/Context)." },
