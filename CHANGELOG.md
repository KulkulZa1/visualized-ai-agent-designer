...
### Fixed
- **Stopped nodes** — a node still working when you press Stop now shows as stopped (grey ■, also in the run panel and timeline) instead of "Skipped by gateway" with a red "Stopped by user" error.
